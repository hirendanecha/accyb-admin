export const routes = {
  ...
  module: {
    event: '/module/events',
    createEvents: '/module/events/create',
    eventDetails: (id: string) => `/module/events/${id}`,
    editEvent: (id: string) => `/module/events/${id}/edit`,
    viewEvent: (id: string) => `/module/events/${id}`,
    news: '/module/news',
    createNews: '/module/news/create',
    newsDetails: (id: string) => `/module/news/${id}`,
    editNews: (id: string) => `/module/news/${id}/edit`,
    viewNews: (id: string) => `/module/news/${id}`,
  },
